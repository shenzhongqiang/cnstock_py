...
if __name__ == "__main__":
    ...
    with open("/var/www/stock/index.html", "w", encoding="gbk") as f:
        ...
        if opt.stock:
            f.write("<br/><br/>")
            f.write("concept zhangting stocks<br/>")
            f.write(df_concept_hot_stocks.to_html())
            f.write("<br/><br/>")
            f.write("industry zhangting stocks<br/>")
